	...
	public partial class SQLiteConnection : IDisposable
	{
		...
		public int Insert (object obj, string extra, Type objType)
		{
			...
			lock (insertCmd) {
				...
				try {
					...
					if (SQLite3.ExtendedErrCode (this.Handle) == ExtendedResult.ConstraintNotNull) {
		...
		public int Update (object obj, Type objType)
		{
			...
			try {
				...
				if (ex.Result == Result.Constraint && SQLite3.ExtendedErrCode (this.Handle) == ExtendedResult.ConstraintNotNull) {
